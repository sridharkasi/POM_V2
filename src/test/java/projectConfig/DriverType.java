...
public enum DriverType implements DriverSetup {
    ...
    FIREFOX {
        public DesiredCapabilities getDesiredCapabilities() {
           System.setProperty("webdriver.gecko.driver", DriverFactory.workingDirectory+"/Drivers/geckodriver.exe");     		 
    ...
    CHROME {
        public DesiredCapabilities getDesiredCapabilities() {
        	System.setProperty("webdriver.chrome.driver",DriverFactory.workingDirectory+"/Drivers/chromedriver.exe");
